      ...
      <div className="flex flex-1 pt-16">
        ...
        <main className={`flex-1 ${isSidebarCollapsed ? 'ml-20' : 'ml-64'} p-8 overflow-y-auto`}>
          <div className="bg-white shadow-lg rounded-xl p-8">
            <h1 className="text-3xl font-bold mb-6 text-gray-600">Contacts</h1>
            <div className="flex flex-col md:flex-row justify-between items-center mb-8 space-y-4 md:space-y-0">
              <div className="flex space-x-4 w-full md:w-auto">
                ...
                />
                <button className="bg-blue-600 text-white px-6 py-2 rounded-lg flex items-center hover:bg-blue-600 transition duration-300">
              ...
              <div className="flex space-x-4 w-full md:w-auto">
                ...
                <button className="bg-gray-400 text-white px-6 py-2 rounded-lg flex items-center hover:bg-gray-500 transition duration-300">
                  <FontAwesomeIcon icon={  faUpload} className="w-4 h-4 mr-2" /> Export
                </button>
