...
//   {
//     image: '/Callcenter.png',
//     title: 'Connect in Any Language',
//     description: 'Send voice notes in local dialects to reach non-English speaking audiences.'
//   },
//   {
//     image: '/Email-campaign.png',
...
//               >
//                 <img src={slides[currentSlide].image} alt={slides[currentSlide].title} className="w-32 h-32 object-contain mb-4" />
...
//           <h1 className="text-3xl font-bold text-gray-900 mb-8 text-center">Create your mNotify account</h1>
