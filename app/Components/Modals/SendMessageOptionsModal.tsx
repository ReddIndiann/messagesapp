...
const SendMessageOptionsModal = ({ isOpen, onClose, onQuickSMSClick, onSendToGroupClick }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-4 sm:p-6 md:p-8 lg:p-10 rounded-lg shadow-lg w-full max-w-sm sm:max-w-md lg:max-w-lg">
        ...
        <button
          className="w-full bg-gray-100 text-gray-400 py-2 rounded mb-2 hover:bg-orange-100 hover:text-orange-400 text-sm sm:text-base"
          onClick={() => {
            onClose();
            onQuickSMSClick();
          }}
